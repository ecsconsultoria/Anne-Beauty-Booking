# 📚 Anne Beauty Booking System - Documentation Index
...
#### Launch the System
→ **QUICK_START.md** (Section: "🚀 Installation & Launch")

#### Change the Password
→ **QUICK_START.md** (Section: "🔧 Customization - Change Admin Password")
...
→ **QUICK_START.md** (Section: "🔧 Customization - Change Business Hours")  
→ **src/database.js**
...
→ **SETUP.md** (Section: "Installation Issues")
...
#### Change Phone Number
→ **QUICK_START.md** (Section: "🔧 Customization - Change Phone")

#### Add More Services
→ **src/routes/client.js** (Modify service options in form)

#### Change Available Dates
→ **src/database.js** (Modify date range logic)

#### Understand the Database
→ **API_DOCUMENTATION.md** (Section: "Database Schema")  
...
```
📁 Root Directory (anne-beauty-booking/)
│
...
├── 📁 views/ (Web Pages)
│   ├── index.ejs ....................... Home page
│   ├── client-booking.ejs .............. Booking form
│   ├── client-confirmation.ejs ......... Confirmation
...
3. **Code questions?** → README.md Technical section
4. **API questions?** → API_DOCUMENTATION.md
5. **Architecture questions?** → .github/copilot-instructions.md
...
- **What features?** → FEATURES_CHECKLIST.md
- **Technical?** → README.md
- **API details?** → API_DOCUMENTATION.md
- **Architecture?** → .github/copilot-instructions.md
- **Portuguese?** → GUIA_COMPLETO.txt
...
**🌟 Welcome to Anne Beauty Booking System!**
